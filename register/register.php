...
<div class="registration-form">
    <form name="registration" method="post" action="create.php" onsubmit="return validate_form ( );">
        Login:<br>
        ...
        <input type="password" name="passwd" min="4" placeholder=" At least 4 characters" required><br>
